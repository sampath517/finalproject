...
>("/signup", async (req, res) => {
    try {
        ...
        const token = jwt.sign(user.username, "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..wExoY22MGhSF6dgfNcb6vLMJFuSd3IqhCEDA25Aobz8");
    ...
    try {
        ...
        if (await bcrypt.compare(password, user.password)) {
            const token = jwt.sign(
                user.username,
                "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..wExoY22MGhSF6dgfNcb6vLMJFuSd3IqhCEDA25Aobz8"
            );
